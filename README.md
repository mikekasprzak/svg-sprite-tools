...
## svg-sprite-css
Takes an svg-sprite package and generates a CSS file containing widths. It assumes all icons are `1em` tall (i.e. you change the font-size to make it bigger).
